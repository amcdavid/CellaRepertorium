...
plotReducedDim(only_paired, use_dimred = 'PCA', colour_by = c('pairing', 'canonical'))
```

Since the `ContigCellDB` is nested within the `SingleCellExperiment` it automatically gets subsetted appropriately when the parent object is subsetted.
